...
export const AiSectionAbout = () => {
    return (
        <section className='py-24 max-md:py-10 flex items-center w-full max-w-[1200px] px-8 gap-8 max-md:flex-col'>
            <div className="w-full  max-md:aspect-video overflow-hidden rounded-3xl aspect-[3/4]">
                <img src="./assets/views/ai/gaming.gif" draggable={false} className='bg-background_secondary w-full h-full object-cover' alt="" />
            </div>
