        ...
        <section className='w-full h-[50dvh] relative p-4 '>
            ...
            <div className="absolute w-full h-full top-0 left-0 p-8 flex justify-center pointer-events-none">
                ...
                <div className="w-full max-w-[1200px] h-full flex flex-col gap-4 max-md:gap-3 justify-center items-start text-start max-md:text-center">
                    <h1 className='text-7xl font-bold max-md:text-4xl max-md:w-full'>Roadmap</h1>
                    <p className='text-2xl w-2/3 max-md:text-xl max-md:w-full'>We have successfully developed the platform architecture and laid the groundwork for AI integration, setting the stage for a robust and innovative gaming experience.</p>
                </div>
            </div>
        </section>
    )
